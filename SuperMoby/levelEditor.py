...
for tile in range(0, MAX_COLS):
    world_data[ROWS - 1][tile] = 0  # begins at img 0
...
for i in range(len(img_list)):
    tile_button = button2.Button(SCREEN_WIDTH + (75 * button_col) + 50, 75 * button_row + 50, img_list[i], 1)
...
while run:
    ...
    # get mouse position
    pos = pygame.mouse.get_pos()  # gives mouse x and y coordinates on the screen
    x = (pos[0] + scroll) // TILE_SIZE  # + scroll because everything is scrolling
    y = pos[1] // TILE_SIZE  # // TILE_SIZE to figure out what tile in the grid we are in
    ...
    if pos[0] < SCREEN_WIDTH and pos[1] < SCREEN_HEIGHT:
        ...
        if pygame.mouse.get_pressed()[2] == 1:
            world_data[y][x] = -1  # -1 means nothing is in there

    # print(pos) #prints position of mouse on screen
    # print(x)
